// 菱形擦除：密度控制大小，支援波紋擴散
Shader "CatzTools/SceneFlow/DiamondWipe"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float dist = center.x + center.y;
                float maxDist = 1.0 + _Smoothness;
                ...
                if (_RippleStrength > 0.001)
                {
                    ...
                    float tileDist = diff.x + diff.y;
                    float maxTileDist = screenCenter.x + screenCenter.y;
